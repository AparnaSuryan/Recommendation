...
def SimilarCuisines(cuisine):
    ...
    if len(list_cuisines) > 0:
        dict_cuisines['message_cuisine'] = 'Users who searched ' + str(cuisine).title() + ' cuisine have also searched for: '
...
#     dict_cuisines['cuisines'] = list(cuisines[(corr_ind<1.0) & (corr_ind>0.3)])
#     return dict_cuisines
